...
from Gender_Prediction_Model import load_classifier
...
parser.add_argument('--dataset', default="Indian_names_dataset.csv", help='Dataset csv to test on within data subdir')
...
args.dataset = PROJECT_DIR+"/Data/Gender_Prediction_data/"+args.dataset
